...
const clube = [
  ...
  { title: 'Acesso via Pulseira', body: '<ul class="bs-steps"><li><strong>Acesso por pulseira:</strong> O acesso à unidade e às áreas do Club é realizado integralmente por meio da pulseira.</li><li><strong>Abertura ágil:</strong> Aproxime a pulseira da fechadura eletrônica para destravar a porta da sua unidade.</li><li><strong>Segurança integrada:</strong> A pulseira é de uso pessoal e intransferível. Em caso de perda, informe imediatamente a recepção para bloqueio e emissão de uma nova via.</li></ul>' },
  { title: 'Carrinhos de Golf', body: '<p class="bs-model-tag">Disponível</p><ul class="bs-steps"><li><strong>Transporte interno:</strong> Os carrinhos de golfe estão disponíveis para deslocamentos dentro do Home Club. Para solicitar, entre em contato com a recepção pelo WhatsApp.</li></ul>' },
