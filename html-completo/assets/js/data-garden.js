const TIPOLOGIA = {
  ...
  guia: [
    ...
    },
    {
      ...
      label: 'Suíte',
      items: [
        { id: 'hidro-jacuzzi', icon: 'droplets', title: 'Banheira Hidro Jacuzzi', body: '<ul class="bs-steps"><li><strong>Imersão e Uso:</strong> Antes de acionar o motor, certifique-se de que o nível da água cubra completamente todos os jatos laterais. Utilize os comandos integrados para ligar o sistema de hidromassagem e aproveitar o momento.</li><li><strong>Bem-Estar e Tempo Ideal:</strong> Para uma experiência segura e revigorante, recomendamos um tempo máximo de uso de 20 a 30 minutos por sessão, evitando quedas de pressão ou desconforto térmico.</li><li><strong>Cuidados e Higiene:</strong> Para garantir a perfeita conservação do equipamento e a pureza da água, não é permitido o consumo de alimentos e bebidas no interior da banheira. Utilize apenas sais e produtos específicos para hidromassagem.</li></ul>' }
      ]
    }
  ],
