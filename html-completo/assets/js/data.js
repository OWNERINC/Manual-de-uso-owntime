/**
 * data.js — Own Time Home Club · Diretório Digital
 *
 * Este arquivo é o único ponto de edição de conteúdo.
 * Atualize os campos abaixo com os textos reais antes do deploy.
 */
...
const OWNTIME = {
  ...
  brand: {
    ...
    concierge: {
      whatsapp:     '+5554999999999', // ← Atualizar com número real (apenas dígitos)
      checkoutTime: '12:00'
    }
  },
