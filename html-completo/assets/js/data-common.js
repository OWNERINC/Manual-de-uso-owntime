const COMMON = {
  ...
  orientacoesGerais: [
    ...
    },
    {
      ...
      subtitle: '',
      body:     '<ul class="bs-steps"><li>Seu pet é parte da família e muito bem-vindo! Para garantir o conforto de todos, conheça as regras e taxas da nossa política pet.</li></ul><p class="bs-model-tag" style="margin-top:1.25rem">Taxas</p><ul class="bs-steps"><li>A hospedagem de pets está sujeita à cobrança de diárias de R$ 85,00 por animal, além da taxa de limpeza final da unidade.</li><li>Para mais informações, consulte a recepção.</li></ul><p class="bs-model-tag" style="margin-top:1.25rem">Comodidades</p><ul class="bs-steps"><li>Caso deseje, solicite caminhas, comedouros e tapetes higiênicos com pelo menos 7 dias de antecedência ao check-in.</li></ul><p class="bs-model-tag" style="margin-top:1.25rem">Serviços</p><ul class="bs-steps"><li>Durante o período de Soft Opening, os serviços sob demanda para pets ainda não estão disponíveis.</li></ul><div class="bs-notice"><strong>Recomendações</strong><ul><li>Mantenha seu pet sempre com guia ou coleira nas áreas comuns do empreendimento.</li><li>O acesso de animais às áreas compartilhadas do Club House não é permitido.</li><li>O proprietário é responsável pela higiene e limpeza dos resíduos do animal nas áreas comuns.</li><li>Mantenha seu pet sob controle durante toda a estadia, evitando situações que possam causar desconforto aos demais proprietários e hóspedes.</li></ul></div><a href="https://wa.me/5554999588947" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:center;gap:0.5rem;margin-top:1.25rem;padding:0.85rem 1rem;background:var(--color-accent);color:#fff;border-radius:8px;text-decoration:none;font-family:var(--font-body);font-size:0.85rem;font-weight:500;letter-spacing:0.02em;-webkit-tap-highlight-color:transparent"><i data-lucide="message-circle"></i> Falar com a Recepção</a>'
    }
  ],
