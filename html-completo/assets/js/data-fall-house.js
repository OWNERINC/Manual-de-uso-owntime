const TIPOLOGIA = {
  ...
  cozinha: [
    { id: 'sala-banho', icon: 'droplets', title: 'Sala de Banho · SPA Jacuzzi', body: '<ul class="bs-steps"><li><strong>Soft Opening:</strong> A Sala de Banho · SPA Jacuzzi estará disponível em breve. Durante esta fase inicial, encontra-se temporariamente indisponível. Agradecemos sua compreensão.</li><li>A nossa equipe está à disposição para encher a sua sala de banho spa jacuzzi (todos os dias das 8h às 20h) e passar in loco as devidas orientações de uso. Faça contato agora com o time de anfitriões.<br><small>*O tempo de espera para encher é de 2h.<br>**Não é permitido o uso de sais de banho e nenhum tipo de óleo ou bolhas.</small></li></ul>' },
