const COMMON = {
  ...
  concierge: [
    ...
    },
    {
      ...
      title: 'Housekeeping',
      hours: '',
      body:  '<p class="bs-model-tag">Serviço incluído</p><ul class="bs-steps"><li>Cada semana de uso da unidade contempla uma arrumação simplificada, com troca de roupas de cama e banho e reposição do enxoval.</li></ul><p class="bs-model-tag" style="margin-top:1.25rem">Serviços adicionais</p><ul class="bs-steps"><li>Caso deseje, é possível contratar um serviço completo de limpeza e arrumação da unidade, incluindo reposição de amenities e organização dos ambientes.</li><li>Para consultar valores e realizar o agendamento, entre em contato com o Time de Anfitriões.</li></ul><p class="bs-model-tag" style="margin-top:1.25rem">Importante</p><ul class="bs-steps"><li>A limpeza da cozinha, da louça e da churrasqueira não está incluída no serviço básico e pode ser contratada separadamente.</li><li>O agendamento deve ser realizado com, no mínimo, 24 horas de antecedência.</li></ul>'
    },
    {
      id:    'babysitter',
      icon:  'heart',
