...
## Exportação Completa de Textos · Atualizado em 30/Jun/2026

> Cada seção corresponde a um "sheet" (gaveta) que abre ao tocar no item.
> Itens marcados com *(pendente)* estão sem conteúdo definitivo — os placeholders entre `[colchetes]` precisam ser preenchidos pela equipe Own Time antes da publicação.
...
### Sheet · Ler mais (Sobre o Own Time)

**Parágrafo 1:**
O empreendimento é composto por 24 casas e 40 apartamentos tipo flat, operando sob o regime de multipropriedade, onde cada proprietário é titular de frações de tempo que conferem o direito de uso exclusivo de sua unidade nos períodos definidos pelo Calendário Anual. A administração e operação é conduzida pela Own Time Administradora e Casa Hotéis Administradora, responsáveis pela gestão do condomínio e dos sistemas de multipropriedade.

**Parágrafo 2:**
Sua unidade foi projetada com arquitetura contemporânea alpina: materiais naturais como madeira, pedra local e tecidos quentes combinados com iluminação indireta para oferecer a sensação de uma casa perfeita na montanha. Cada ambiente foi pensado para proporcionar o máximo de conforto térmico, acústico e visual.
...
## PÁGINAS DE TIPOLOGIA — HERO

Todas as tipologias exibem o badge: `Diretório V1 · Em teste`
...
**Subtítulo:** Sua casa de 4 suítes em Gramado. Use este guia para encontrar tudo que você precisa durante a estadia.
**Descrição (features):** Casa de alto padrão com 4 suítes, área gourmet completa e espaços projetados para convívio e conforto em meio à Serra Gaúcha.
...
**Subtítulo:** Sua casa de 3 suítes em Gramado. Use este guia para encontrar tudo que você precisa durante a estadia.
**Descrição (features):** Casa de alto padrão com 3 suítes, área gourmet completa e espaços projetados para convívio em meio à Serra Gaúcha.
...
**Subtítulo:** Seu apartamento garden em Gramado. Use este guia para encontrar tudo que você precisa durante a estadia.
**Descrição (features):** Apartamento garden de alto padrão com acesso direto ao jardim e hidro jacuzzi exclusivo.
...
**Subtítulo:** Seu apartamento cobertura em Gramado. Use este guia para encontrar tudo que você precisa durante a estadia.
**Descrição (features):** Apartamento cobertura de alto padrão com mini spa terrace jacuzzi exclusivo no terraço privativo.
**Stats:** ≈ 60 m² · 1 Suíte · 1 Vaga
...
- **Acesso Controlado:** O ingresso ao empreendimento é realizado por reconhecimento facial.

**Como Chegar** *(dois botões de mapa no sheet):*

| Botão | Rua | Link |
|---|---|---|
| Entrada Principal | R. Ricardo Sturmhoffel | https://maps.app.goo.gl/u47vsE128QFgDaef9 |
| Serviços · Fornecedores | R. João XXIII, 222 | https://maps.app.goo.gl/FmiiuFZ4pBUzGycWA |
...
- **Solicitação de Retirada:** Quando precisar sair, solicite o seu carro na recepção ou pelo `[WhatsApp/link]` com `[tempo, ex: 15 min]` de antecedência.

---

## TELEFONES ÚTEIS

*(Nova seção — aparece em todas as tipologias após Orientações Gerais. Cada item abre o discador ao toque.)*

> **Pendente:** substituir todos os `[número]` e `[nome]` pelos dados reais antes de publicar.
...
|---|---|---|
| ambulance | SAMU | 192 |
| flame-2 | Bombeiros | 193 |
| shield | Polícia Militar | 190 |

### Saúde

| Ícone | Nome | Número |
|---|---|---|
| hospital | Hospital Bom Jesus | `(54) [número]` |
| pill | Farmácia `[nome]` | `(54) [número]` |

### Ownerinc

| Ícone | Nome | Contato |
|---|---|---|
| phone | Recepção Club House | `[ramal 9]` |
| message-circle | WhatsApp Anfitriões | `+5554999999999` |

### Gastronomia

| Ícone | Nome | Número |
|---|---|---|
| utensils | `[Restaurante 1]` | `(54) [número]` |
| utensils | `[Restaurante 2]` | `(54) [número]` |
| utensils | `[Restaurante 3]` | `(54) [número]` |

### Mercados & Farmácias

| Ícone | Nome | Número |
|---|---|---|
| shopping-cart | `[Mercado 1]` | `(54) [número]` |
| shopping-cart | `[Mercado 2]` | `(54) [número]` |
...
- **Temperatura de Conforto:** Para um ambiente perfeitamente agradável, sugerimos manter o equipamento configurado entre `[temperatura, ex: 22°C a 24°C]`.
- **Observação:** `[Alinhar com a Incorp sobre a variação do AC dos apartamentos para as casas]`.
...
- **Como Conectar:** Rede: `[nome da rede]` · Senha: `[senha]`
...
- Utilize exclusivamente trajes de banho apropriados. O uso de recipientes de vidro é estritamente proibido em toda a área das piscinas.
- Para manter a temperatura ideal do ambiente, a movimentação das esquadrias é feita apenas pela nossa equipe de operação.
...
*Horário: 12h00 às 22h00 · último pedido às 21h30*
...
- **Restrições Alimentares:** Nossa equipe está à disposição para detalhar ingredientes e adaptar pratos conforme as suas necessidades.
...
- **Coquetelaria Autoral:** Carta de drinks sofisticada, com opções clássicas e criações autorais pensadas para surpreender o paladar.
- **Curadoria de Vinhos:** Seleção cuidadosa de rótulos nacionais e internacionais, com destaque para os vinhos da Serra Gaúcha. `[LINK PARA CARDÁPIO]`
...
- Cestas devem ser solicitadas até as 15h para o dia seguinte e poderão ser entregues das 7h às 22h pelo contato da recepção.
...
- **Intermediação de Serviços:** Facilitamos reservas de restaurantes, agendamento de passeios, locação de veículos, contratação de fotógrafos e outras experiências locais.
- **Curadoria Autêntica de Gramado:** Recomendações personalizadas de cafés discretos, caminhos silenciosos e rótulos selecionados que fogem dos mapas turísticos óbvios.
...
- **Serviços Disponíveis:** Pet Walker e Banho & Tosa disponíveis.
...
- Solicite com antecedência mínima de 24h pelo WhatsApp dos Anfitriões ou pelo ramal 9.
- Disponível para crianças até 3 anos.
- Custo: `[gratuito / R$ XX por noite]` — confirmar com recepção. *(pendente)*

---

### Configuração de Camas *(novo)*

*Ícone: bed-double*

- Algumas suítes permitem alterar a configuração entre cama king e duas camas twins. Consulte a disponibilidade pelo ramal 9 ou WhatsApp.
- **Fall House:** Suíte `[X]` — permite divisão. *(pendente)*
- **Winter House:** Suíte `[X]` — permite divisão. *(pendente)*
- Solicite com pelo menos 24h de antecedência.

---

### Roupa de Cama Extra *(novo)*

*Ícone: layers*

- Travesseiros, edredons e fronhas extras disponíveis mediante solicitação ao time de Housekeeping.
- Acione pelo ramal 9 ou WhatsApp dos Anfitriões a qualquer momento.

---

### Acesso de Convidados *(novo)*

*Ícone: users*

- Hóspedes podem convidar visitantes externos para uso das áreas comuns do clube mediante autorização prévia na recepção.
- Taxa de visitante: R$ `[XX]` por pessoa por dia. *(pendente)*
- Limite: `[X]` visitantes por unidade por dia. *(pendente)*
- Crianças até `[X]` anos: cortesia. *(pendente)*
- Para autorizar: dirija-se à recepção do Club House com o nome dos convidados.
...
- **Supervisão:** Para garantir o bem-estar coletivo, é fundamental que as crianças permaneçam sob a supervisão constante de um adulto responsável.
- **Programação Especial:** Durante as temporadas e datas comemorativas, o Club oferece cronograma exclusivo com jogos e atividades dirigidas.
...
- **Acesso:** Feito de forma independente por qualquer jovem que porte o cartão da unidade. O ambiente é acompanhado 24 horas pelo sistema de monitoramento via CFTV.

---

### Playground Externo

- **Diversão ao Ar Livre:** Espaço lúdico e seguro, projetado para garantir o entretenimento e estimular as brincadeiras das crianças.
- **Supervisão:** Os pequenos devem estar sempre acompanhados por um adulto responsável durante o uso.
...
- **Mobilidade e Conforto:** Nossa frota estará totalmente à sua disposição para facilitar o deslocamento por toda a extensão do Club.
...
- **Conexão Simples:** Estacione nas vagas exclusivas de recarga e conecte o cabo ao seu veículo.
- **Tarifação por Consumo:** O serviço é faturado baseado exclusivamente na energia utilizada.
- **Uso Compartilhado:** Assim que a carga for concluída, desconecte o equipamento e libere o espaço para os demais hóspedes.
...
- **Monitoramento:** As áreas comuns são protegidas por sistema de CFTV com `[INSERIR NÚMERO]` câmeras em pontos estratégicos.
- **Vigilância:** Equipe de segurança especializada realizando controle contínuo do ambiente.

---

### Cartão de Acesso

- **Uso e Conservação:** Para abrir as portas, aproxime o cartão do leitor. Armazene-o com cuidado, evitando mantê-lo próximo a aparelhos celulares e fechos magnéticos.
- **Logística:** Os cartões devem ser retirados na recepção no momento da chegada e devolvidos ao encerrar a estadia.
- **Taxa de Reposição:** Em caso de perda ou extravio, haverá cobrança de uma taxa de reposição no acerto final.
...
*(Sheet acessado pelo botão "Sugestões e melhorias" no hero de cada tipologia)*

**Seletor de categoria:** O hóspede escolhe antes de escrever:
- **Imóvel** — observações sobre a unidade, instalações, equipamentos
- **Serviços** — atendimento, concierge, gastronomia, housekeeping
- **Outro** — qualquer outro tema

**Campo de texto:** Até 500 caracteres.
**Foto:** Opcional — upload ou câmera, comprimida para 1280px/75% antes do envio.

**Destino:** Planilha Google Sheets. Colunas: Data/Hora · Categoria · Tipologia · Dispositivo · Sugestão · Foto (link Drive).

> **Ação pendente no Apps Script:** Adicionar manualmente a coluna "Categoria" na posição B da planilha existente (antes de Tipologia), pois a linha de cabeçalho já foi criada sem ela. Depois, fazer novo deploy do script com o código em `sugestao-apps-script.js`.
...
- **Como Acender:**
  1. Posicione a lenha fornecida pela operação no centro do equipamento, em formato de pirâmide.
  2. Insira o acendedor ecológico na base da estrutura.
  3. Utilize o fósforo longo (disponível no kit lareira) para acender a base com segurança.
  4. Aguarde a formação da brasa antes de adicionar novos troncos.
...
- **Imersão e Uso:** Antes de acionar o motor, certifique-se de que o nível da água cubra completamente todos os jatos laterais.
- **Bem-Estar:** Recomendamos um tempo máximo de uso de 20 a 30 minutos por sessão.
- **Cuidados e Higiene:** Não é permitido o consumo de alimentos e bebidas no interior da banheira. Utilize apenas sais e produtos específicos para hidromassagem.

---

### Mini Spa Terrace Jacuzzi *(Terraço — Mini Spa Terrace)*

- **Exclusividade da Cobertura:** Localizado na sua sacada, o Mini Spa oferece uma experiência de relaxamento premium ao ar livre.
- **Acionamento:** Verifique se a água cobre completamente os jatos antes de ligar o sistema de hidromassagem e aquecimento. Sessões de 20 a 30 minutos.
- **Preservação:** Não é permitido o consumo de alimentos e bebidas no interior do equipamento. Utilize exclusivamente sais e espumas homologados para spas.

---

### Sala de Banho · SPA Jacuzzi *(Fall House)*

- **Apresentação:** Para a sua comodidade e relaxamento, a jacuzzi da sua sala de banho está pronta para uso sob solicitação.
- **Funcionamento:** A nossa equipe está à disposição para encher a sua sala de banho spa jacuzzi (todos os dias das 8h às 20h) e passar in loco as devidas orientações de uso. Faça contato agora com o time de anfitriões.
- **Nota (Aviso):**
...
- **Acendimento e Uso:** Utilize exclusivamente a lenha ou o material fornecido e recomendado pela nossa equipe. Aguarde o forno atingir a temperatura ideal.
- **Segurança:** Nunca utilize líquidos inflamáveis, plásticos ou qualquer outro combustível não autorizado. Para solicitar os insumos adequados, acesse o `[contato]`.
...
- **Acendimento Seguro:** Utilize apenas carvão apropriado e acendedores sólidos ou em gel. Certifique-se de acionar o sistema de exaustão antes de acender o fogo.
- **Cuidados Essenciais:** É estritamente proibido o uso de álcool líquido. Ao finalizar, deixe as brasas apagarem naturalmente.

---

### Adega Climatizada *(todas as tipologias)*

- **Temperatura Ideal:** Mantenha seus rótulos preservados nas condições perfeitas. O equipamento opera de forma silenciosa e com controle térmico estável.
- **Experiência e Curadoria:** Espaço ideal para acomodar a sua coleção pessoal ou as seleções especiais sugeridas pelo sommelier do Club, Cristiano Ribeiro.
...
### Máquina de Café *(todas as tipologias)*
...
- **Seu Café:** Pressione qualquer botão para ligar a máquina. Quando as luzes pararem de piscar, selecione a medida desejada (Espresso ou Lungo).
- **Manutenção:** A cápsula usada cai automaticamente no compartimento interno assim que a alavanca for levantada para o próximo uso.

---

### Lava-louças *(todas as tipologias)*

*Modelo: Tramontina Inox*

- **Organização:** Remova o excesso de alimentos da louça antes de acomodá-la nos cestos.
...
- **Acionamento:** Selecione o ciclo desejado no painel de controle e feche a porta com firmeza para que a máquina inicie automaticamente.

---

### Lava e Seca *(Fall House · Winter House)*

- **Capacidade Ideal:** Suporta até 11kg para ciclos de lavagem e 7kg se for utilizar a função contínua de secagem.
- **Preparo:** Insira as roupas e adicione os produtos de limpeza nos compartimentos indicados na gaveta frontal.
- **Ciclo Simples:** Gire o seletor central para escolher o programa e pressione o botão "Início/Pausa".

---

### Fogão + Depurador *(Fall House · Winter House)*

- **Uso do Cooktop:** Pressione e gire o manípulo correspondente à boca desejada para acendimento automático. Ajuste a intensidade da chama conforme o preparo.
- **Controle da Coifa:** Acesse o painel para acionar a iluminação de apoio e ajustar a velocidade de exaustão.
- **Dica de Conforto:** Ligue a coifa instantes antes de começar a cozinhar e mantenha-a funcionando por mais alguns minutos após o término.
...
### Cooktop de Indução e Coifa Tramontina

- **Eficiência por Indução:** Ligue o cooktop de 2 bocas diretamente no painel touch. Utilize as panelas magnéticas já disponibilizadas na cozinha.
- **Purificação Silenciosa:** Acione a coifa de ilha Black Steel para manter o ar sempre limpo.
...
- **Design Inteligente:** O formato Inverse posiciona o refrigerador na parte superior e o freezer na base.
- **Conservação Ideal:** O equipamento já opera na temperatura recomendada para o clima da serra.
...
- **Controle Inteligente:** Utilize o painel touch Glass Black para acessar as diversas funções de assamento e ajustar a temperatura ideal.
- **Cuidados:** Após o desligamento, é normal que o sistema de ventilação continue operando silenciosamente por alguns minutos para resfriar o equipamento com segurança.
...
- **Timer:** Segure o botão da velocidade ativa por 3 segundos — a coifa desligará automaticamente após 5 min.
...
| # | Seção | O que falta |
|---|---|---|
| 1 | Check-in · Mapa | ~~Número da R. João XXIII~~ ✓ R. João XXIII, 222 |
| 2 | Emergência | Ramal da recepção `[xx]` e WhatsApp `[xxxxxxxx]` |
| 3 | Espaço Pet | Número máximo de pets, porte permitido, taxa de limpeza |
| 4 | Telefones Úteis | Todos os números reais de hospitais, farmácias, restaurantes, mercados |
| 5 | Concierge · Berço Extra | Custo (gratuito ou R$ XX/noite) |
| 6 | Concierge · Config. Camas | Quais suítes permitem divisão em Fall e Winter |
| 7 | Concierge · Acesso Convidados | Taxa por visitante, limite por unidade, idade de cortesia |
| 8 | Piscinas | Horário e temperatura da água |
| 9 | Climatização AC | Temperatura recomendada e variação entre tipologias |
| 10 | Conectividade | Nome da rede Wi-Fi e senha |
| 11 | Apps Script · Planilha | Inserir coluna "Categoria" na posição B manualmente + redeploy do script |
| 12 | TV | Conteúdo do sheet ainda não definido |
| 13 | AR Central Apartamentos | Conteúdo do sheet ainda não definido |
