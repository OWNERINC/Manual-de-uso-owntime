  ...
  guia: [
    {
      ...
      items: [
        ...
        { id: 'climatizacao',  icon: 'thermometer', title: 'Climatização',        body: '' },
        ...
        { id: 'fogo-chao',     icon: 'flame',       title: 'Fogo de Chão',        body: '' },
    ...
    },
    {
      ...
      label: 'Cozinha',
      items: [
        { id: 'forno-pizza',    icon: 'utensils', title: 'Forno de Pizza',   body: '' },
        { id: 'churrasqueira',  icon: 'flame',    title: 'Churrasqueira',    body: '' }
      ]
    },
    {
      id: 'sala',
      label: 'Sala',
      items: [
        { id: 'lareira', icon: 'flame', title: 'Lareira', body: '' }
      ]
    },
    {
      id: 'segundo-andar',
      ...
      items: [
        ...
        { id: 'iluminacao-2a',       icon: 'lightbulb',   title: 'Iluminação',                 body: '' },
        { id: 'climatizacao-2a',     icon: 'thermometer', title: 'Climatização',               body: '' },
        { id: 'piso-aquecido-2a',    icon: 'flame',       title: 'Piso Aquecido',              body: '' }
      ]
    },
    {
      id: 'eletros',
