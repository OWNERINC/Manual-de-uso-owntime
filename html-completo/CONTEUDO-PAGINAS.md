...
> Atualizado em 2026-06-22. Reflete exatamente o que aparece na tela em cada página, na ordem de renderização.
> Itens com *(pendente)* exibem "Instruções em breve." para o usuário enquanto o conteúdo não for preenchido.

---
---

# PÁGINA 1 — index.html · Hub Central

**Função:** Tela de entrada. Apresenta o clube e direciona para a tipologia do hóspede.

---

## Topo da página

**Label:** Own Time Home Club · Gramado

**Logo:** assets/logo.png

**Texto de apresentação:**
Descubra o equilíbrio perfeito entre o conforto de casa, a beleza da natureza e a exclusividade de um clube com serviços de hotelaria de alto padrão.

**Botão "Ler mais"** → abre bottom sheet com o texto completo:
...
**Fall House** — Casa 4 Suítes · 448 m² · Até 10 hóspedes → fall-house.html

**Winter House** — Casa 3 Suítes · 325 m² · Até 8 hóspedes → winter-house.html

**Garden** — Apartamento · ≈ 60 m² · Para pequenos núcleos → garden.html

**Cobertura** — Apartamento · ≈ 60 m² · Para pequenos núcleos → terraco.html

---
---

# PÁGINA 2 — fall-house.html · Fall House · Casa 4 Suítes
...
**Texto do empreendimento (dentro do hero):**
...
### Check-out · Horário Padrão: 12h00
Solicitamos a liberação da unidade no horário previsto para que a equipe de governança possa preparar o espaço para o próximo proprietário com o mesmo cuidado e atenção aos detalhes que você encontrou na sua chegada.
...
### Espaço Pet · Orientações Gerais
O Own Time é um empreendimento pet friendly, porque entendemos que para muitas famílias o pet é parte essencial do núcleo familiar.
...
**Acesso às Unidades** → *(pendente)*

**Iluminação** → *(pendente)*

**TV** → *(pendente)*

**Ventilação / Exaustão** → *(pendente)*

**Piso Aquecido** → *(pendente)*

**Telefone** → *(pendente)*

**Fogo de Chão** → *(pendente)*

**Inverter** → *(pendente)*

### Cozinha

**Forno de Pizza** → *(pendente)*

**Churrasqueira** → *(pendente)*

### Segundo Andar

**Sala de Banho · SPA Jacuzzi** → *(pendente)*

**Climatização** → *(pendente)*

### Eletros

**Adega Climatizada** → *(pendente)*

**Geladeira** — Brastemp Frost Free 500L
...
**Micro-ondas** — Tramontina Glass Cook 25L
...
**Forno Elétrico** — Tramontina Glass Cook 73L
...
**Máquina de Café** → *(pendente)*

**Lava-louças** → *(pendente)*

**Lava e Seca** → *(pendente)*

**Fogão + Depurador** → *(pendente)*

**Filtro de Água** — Consul Purificador Facilite
...
## Club House
**"O clube, ao seu alcance."**

### Empório
Espaço de conveniência interna com seleção de produtos premium e itens essenciais para a sua estadia. Instruções detalhadas de funcionamento e catálogo em breve.

### Kids
Funcionamento: 09h00 às 21h00
...
### Playground Externo → *(pendente)*

### Acesso via Pulseira → *(pendente)*

### Carrinhos de Golf → *(pendente)*

### Carregadores Elétricos → *(pendente)*

---

## Conforto & Tecnologia
**"Sua casa, com tudo resolvido."**
Cada detalhe foi pensado para que você chegue e simplesmente viva. Consulte abaixo as informações de uso dos sistemas da casa.

### Climatização
Sua unidade conta com sistema de climatização individual por ambiente, permitindo o ajuste independente da temperatura em cada cômodo. Para melhor eficiência do sistema, recomendamos manter portas e janelas fechadas durante o uso do ar-condicionado e/ou aquecimento.
...
### Lareira
A lareira da sua unidade é um sistema de alta eficiência térmica, equipada com câmara fechada e controle aprimorado de combustão. Projetada para oferecer conforto térmico nos dias frios da Serra Gaúcha, com menor emissão de fumaça e melhor desempenho energético. Um convite ao escapismo e à reconexão, complementando o ritual de lareira acesa e vinho compartilhado que define a experiência Own Time.
...
## Gastronomia
**"À mesa, em casa."**
Sabores da Serra, do café da manhã à experiência privativa de um chef em casa.

### Restaurante
**Horário:** 12h00 às 22h00 · Último pedido 21h30

Serviço à la carte disponível em ambientes interno e externo, com carta inspirada na gastronomia regional e contemporânea. O restaurante integra o conceito de socialização elegante do Own Time: um espaço onde famílias e amigos compartilham momentos em torno da mesa, com a naturalidade de quem está em casa e a qualidade de um serviço autoral. O menu contempla opções para diferentes perfis e necessidades alimentares. Informações sobre ingredientes e restrições podem ser solicitadas à equipe de salão.

### Coffee Shop
**Horário:** 08h00 às 20h00

Cafés especiais, chás, opções leves e confeitaria artesanal em ambiente descontraído. O Coffee Shop é o ponto de partida do dia para quem aprecia começar a manhã com café especial.

### Bar
**Horário:** 17h00 às 23h00

Carta de drinks autorais e seleção curada de vinhos da Serra Gaúcha e rótulos nacionais e internacionais.

### Chef em Casa
**Horário:** Agendamento com 48h de antecedência via concierge

Serviço exclusivo de chef particular disponível para sua unidade mediante agendamento com antecedência mínima de 48 horas. O chef prepara menu personalizado na cozinha da sua casa, criando uma experiência gastronômica privativa e sob medida: ideal para jantares em família, ocasiões especiais ou simplesmente para quem aprecia cozinhar eventualmente em casa e receber amigos em jantares informais. O agendamento pode ser realizado via recepção ou WhatsApp. Valores e cardápios sob consulta.

### Café da Manhã
O café da manhã combina produtos regionais, confeitaria artesanal, frutas, pães frescos e opções quentes, incluindo experiências para crianças.

---

## Comodidades Pay Per Use
**"Curadoria a seu serviço."**
Serviços personalizados disponíveis sob demanda. Solicite ao seu time de anfitriões com antecedência.

### Time de Anfitriões
Disponível 24h. Realiza a intermediação com prestadores externos: locação de automóveis, fotógrafos, turismo, reservas em restaurantes, passeios e experiências locais. O serviço de concierge é o seu ponto de contato para organizar tudo o que estiver além da estrutura interna do empreendimento. Nosso diferencial é uma curadoria sensível e autêntica de Gramado: cafés discretos, caminhos silenciosos, vinhos que não aparecem nos mapas óbvios. O concierge traduz essa filosofia em recomendações personalizadas.

### Housekeeping Adicional
Além das limpezas incluídas nos Serviços Essenciais do condomínio — que contemplam governança com troca de roupas de cama e banho, arrumação simplificada e lavagem de enxoval no meio da semana — você pode solicitar limpezas adicionais para sua unidade durante a estadia. O serviço inclui arrumação completa, reposição de amenities e organização dos ambientes.

### Babysitter
Serviço de cuidador infantil qualificado, disponível para que os pais possam desfrutar de momentos a dois. O agendamento deve ser feito com antecedência via recepção ou WhatsApp.

### Personal Trainer
Programas personalizados com profissionais certificados. Sessões no Fitness Center ou ao ar livre — individual ou em grupo. Agendamento pelo concierge.

### Pet Care
Serviços de Pet Walker e Banho & Tosa disponíveis para os companheiros de quatro patas. Agendamento com 24h de antecedência junto ao time de anfitriões.
...
Monitoramento e controle de acesso 24 horas para que você aproveite sua estadia com total segurança.

### Monitoramento 24 Horas
O empreendimento conta com portaria e recepção funcionando 24 horas, operadas conforme os procedimentos estabelecidos pela Administradora. O sistema inclui CFTV com câmeras em pontos estratégicos das áreas comuns, monitoradas pela equipe de segurança. A vigilância é realizada de forma permanente, integrando os Serviços Essenciais do condomínio.

### Controle Eletrônico de Acesso
O acesso ao empreendimento e às unidades é controlado por sistema eletrônico permanente. Os dispositivos de acesso são entregues no momento do check-in e devolvidos na recepção ao final da estadia.

### Sistema de Segurança Perimetral
O empreendimento conta com sistema de segurança perimetral que abrange toda a área do condomínio, incluindo acessos, áreas verdes e limites da propriedade. A guarita de controle de acesso principal opera de forma integrada com o sistema de monitoramento.

---

## Barra Flutuante (sempre visível no rodapé)

Check-out **12:00** · Botão **Concierge** → WhatsApp

---
---

# PÁGINA 3 — winter-house.html · Winter House · Casa 3 Suítes

---

## Hero

**Label:** Winter House · Casa 3 Suítes · Guia Digital
...
**Texto do empreendimento (dentro do hero):** *(idêntico ao Fall House — ver acima)*
...
*(Conteúdo idêntico ao Fall House — Check-in, Emergência, Check-out, Pet)*
...
*(Sem Fogo de Chão e Inverter — exclusivos da Fall House)*

### Cozinha

**Churrasqueira** → *(pendente)*

*(Sem Forno de Pizza — exclusivo da Fall House)*

### Segundo Andar

**Climatização** → *(pendente)*

*(Sem Sala de Banho · SPA Jacuzzi — exclusiva da Fall House)*
...
*(Conteúdo idêntico ao Fall House — Empório, Kids, Teens, Playground, Pulseira, Golf Carts, Carregadores)*
...
*(Conteúdo idêntico ao Fall House — Climatização, Lareira, Hidromassagem, Conectividade)*
...
*(Conteúdo idêntico ao Fall House — Restaurante, Coffee Shop, Bar, Chef em Casa, Café da Manhã)*
...
*(Conteúdo idêntico ao Fall House — todos os 7 serviços)*
...
*(Conteúdo idêntico ao Fall House — Monitoramento, Controle de Acesso, Segurança Perimetral)*
...
# PÁGINA 4 — garden.html · Garden · Apartamento Garden
...
*(Sem Fogo de Chão, Inverter — exclusivos da Fall House. Tem AR Central — exclusivo dos aptos)*

### Cozinha

**Fogão Indução** → *(pendente)*

*(Sem Churrasqueira — exclusiva das casas)*

### Eletros

**Adega Climatizada** → *(pendente)*

**Geladeira** — Tramontina Duplex Inverse 435L
Ligar: Pressione o interruptor geral (botão com luz verde).
Temperatura: Ajuste o frio pelas setas no painel de controle.
Dica: Evite deixar a porta aberta — acelera a perda de frio e aumenta o consumo de energia.
...
**Forno Elétrico** — Tramontina Epic T Smart 60
Painel Touch: Use o visor para ligar e acessar todas as funções.
Programação: No ícone "Definições", defina horário para o forno ligar sozinho.
Air Fry: Função embutida para preparos saudáveis sem uso de óleo.

**Máquina de Café** → *(pendente)*

**Lava-louças** → *(pendente)*

**Depurador de Ar** — Tramontina Coifa Square Isla 40
...
*(Sem Lava e Seca, Fogão + Depurador separado, Filtro d'Água — exclusivos das casas)*

### Quartos

**Banheira Hidro Jacuzzi** → *(pendente)*

*(Exclusivo do Garden — no Terraço a jacuzzi fica no Mini Spa Terrace)*
...
# PÁGINA 5 — terraco.html · Terraço · Apartamento Cobertura
...
**Mini Spa Terrace Jacuzzi** → *(pendente)*

*(Exclusivo do Terraço — a jacuzzi fica no terraço privativo, não no quarto como no Garden)*
...
# RESUMO — O que é igual e o que muda entre páginas

## Seções 100% compartilhadas (mesmo conteúdo em todas as 4 tipologias)

- Orientações Gerais (Check-in, Emergência, Check-out, Pet)
- Club House (Empório, Kids, Teens, Playground, Pulseira, Golf Carts, Carregadores)
- Conforto & Tecnologia (Climatização, Lareira, Hidromassagem, Conectividade)
- Gastronomia (Restaurante, Coffee Shop, Bar, Chef em Casa, Café da Manhã)
- Comodidades Pay Per Use (7 serviços)
- Segurança & Acesso (Monitoramento, Controle de Acesso, Segurança Perimetral)
- Barra flutuante (Check-out 12:00 · Concierge WhatsApp)

## O que muda por tipologia

| Item | Fall House | Winter House | Garden | Terraço |
|---|---|---|---|---|
| Área | 448 m² | 325 m² | ≈ 60 m² | ≈ 60 m² |
| Dormitórios | 4 Suítes | 3 Suítes | 1 Quarto | 1 Quarto |
| Hóspedes | 10 | 8 | pequenos núcleos | pequenos núcleos |
| Vagas | 2 | 2 | 1 | 1 |
| Geladeira | Brastemp 500L | Brastemp 500L | Tramontina 435L | Tramontina 435L |
| Forno Elétrico | Tramontina 73L | Tramontina 73L | Epic T Smart 60 | Epic T Smart 60 |
| Fogo de Chão | Sim | Não | Não | Não |
| Inverter | Sim | Não | Não | Não |
| Forno de Pizza | Sim | Não | Não | Não |
| Churrasqueira | Sim | Sim | Não | Não |
| Lava e Seca | Sim | Sim | Não | Não |
| Filtro d'Água | Sim | Sim | Não | Não |
| AR Central | Não | Não | Sim | Sim |
| Fogão | Fogão + Depurador | Fogão + Depurador | Fogão Indução | Fogão Indução |
| Depurador de Ar | (junto ao fogão) | (junto ao fogão) | Coifa separada | Coifa separada |
| Sala Banho SPA | Sim (2º andar) | Não | Não | Não |
| Hidro Jacuzzi | Não | Não | Sim (quarto) | Não |
| Mini Spa Terrace | Não | Não | Não | Sim (terraço) |
